<template>
    <v-item-group selected-class="bg-primary">
        ...
        <v-container>
            ...
            <v-dialog persistent v-if="isFirstVisit" v-model="welcomeDialog" width="auto">
                <v-card>
                    <v-toolbar>
                        ...
                        <template v-slot:append>
                            <v-btn @click="handleFirstVisit" icon="mdi-close"></v-btn>
                        </template>
                    </v-toolbar>
                    <v-card-text>
                        ...
                        Neste momento, você ainda não possui nenhum formulário registrado. Mas não se preocupe, você pode
                        começar a criar o seu primeiro formulário agora mesmo. Basta clicar no botão abaixo e você será
                        direcionado para a criação do seu formulário personalizado.
                        <br><br>

                        Estamos ansiosos para ver o que você vai criar. Não hesite em nos contatar caso precise de alguma
                        ajuda ao longo do processo.

                        Vamos começar?
                    </v-card-text>
                    <v-card-actions>
                        <v-btn block @click="handleFirstVisit" size="large" append-icon="mdi-heart">Começar</v-btn>
                    </v-card-actions>
                </v-card>
            </v-dialog>
